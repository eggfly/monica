...
lv_obj_set_style_text_font(ui_comp_get_child(ui_title_group_2, UI_COMP_TITLEGROUP_TITLE), &ui_font_Subtitle, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_chart_series_t* ui_chart_ecg_series_1 = lv_chart_add_series(ui_chart_ecg, lv_color_hex(0xEE1C18), LV_CHART_AXIS_PRIMARY_Y);
