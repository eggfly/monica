...
lv_obj_set_style_text_font(ui_comp_get_child(ui_city_gruop_2, UI_COMP_TITLEGROUP_TITLE), &ui_font_Subtitle, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_img_set_src(ui_comp_get_child(ui_today_weather_group, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_sun_cloud_png);

lv_obj_set_style_text_color(ui_comp_get_child(ui_today_weather_group, UI_COMP_TODAYWEATHERGROUP_DEGREE_8), lv_color_hex(0xED1E1E), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_comp_get_child(ui_today_weather_group, UI_COMP_TODAYWEATHERGROUP_DEGREE_8), 255, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_img_set_src(ui_comp_get_child(ui_today_weather_group1, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_cloud_png);
...
lv_img_set_src(ui_comp_get_child(ui_today_weather_group2, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_sun_cloud_png);
...
lv_img_set_src(ui_comp_get_child(ui_today_weather_group4, UI_COMP_TODAYWEATHERGROUP_CLOUD_SUN), &ui_img_weather_cloud_fog_png);
