...
public:
  ...
  void onPause() { printf("[%s] onPause\n", getAppName().c_str()); }
  void onDestroy() { printf("[%s] onDestroy\n", getAppName().c_str()); }
};
...
extern "C" void app_main(void) {
  ...
  // /* UI framwork init */
  mooncake_ui.setDisplay(hardware_manager.disp.width(),
                         hardware_manager.disp.height());
  mooncake_ui.init();
  ...
  app_ptr = new UserApps::BlackWatch;
  ...
  app_ptr = new AppTest("CPU", (void *)&ui_img_cpu_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("File Explorer", (void *)&ui_img_folder_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("Graphic Test", (void *)&ui_img_graphic_speed_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("MQTT", (void *)&ui_img_mqtt_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("Video Player", (void *)&ui_img_player_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("Python", (void *)&ui_img_python_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("SDCARD", (void *)&ui_img_sdcard_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("USB", (void *)&ui_img_usb_108_png);
  mooncake_ui.install(app_ptr);
  app_ptr = new AppTest("Wi-Fi", (void *)&ui_img_wifi_108_png);
  mooncake_ui.install(app_ptr);
