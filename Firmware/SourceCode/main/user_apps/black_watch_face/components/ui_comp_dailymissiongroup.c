...
void ui_event_comp_dailymissiongroup_daily_mission_arc(lv_event_t *e) {
  ...
  if (event_code == LV_EVENT_VALUE_CHANGED) {
    _ui_arc_set_text_value(
        comp_dailymissiongroup[UI_COMP_DAILYMISSIONGROUP_MISSION_PERCENT],
        target, "", "%");
  }
}
...
lv_obj_t *ui_dailymissiongroup_create(lv_obj_t *comp_parent) {
  ...
  lv_obj_clear_flag(cui_dailymissiongroup,
                    LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE); /// Flags
  lv_obj_set_style_bg_color(cui_dailymissiongroup, lv_color_hex(0xFFFFFF),
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(cui_dailymissiongroup, 0,
                          LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_color(cui_mission_percent, lv_color_hex(0xEE1E1E),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_opa(cui_mission_percent, 255,
                            LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_text_font(cui_mission_percent, &ui_font_Subtitle,
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_arc_color(cui_daily_mission_arc, lv_color_hex(0x303030),
                             LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_arc_opa(cui_daily_mission_arc, 255,
                           LV_PART_MAIN | LV_STATE_DEFAULT);
  lv_obj_set_style_arc_rounded(cui_daily_mission_arc, true,
                               LV_PART_MAIN | LV_STATE_DEFAULT);

  lv_obj_set_style_arc_color(cui_daily_mission_arc, lv_color_hex(0xB0E14A),
  ...
  lv_obj_set_style_bg_color(cui_daily_mission_arc, lv_color_hex(0xFFFFFF),
                            LV_PART_KNOB | LV_STATE_DEFAULT);
  lv_obj_set_style_bg_opa(cui_daily_mission_arc, 0,
                          LV_PART_KNOB | LV_STATE_DEFAULT);

  lv_obj_t **children =
      lv_mem_alloc(sizeof(lv_obj_t *) * _UI_COMP_DAILYMISSIONGROUP_NUM);
  ...
  children[UI_COMP_DAILYMISSIONGROUP_DAILY_MISSION_IMAGE] =
      cui_daily_mission_image;
  children[UI_COMP_DAILYMISSIONGROUP_DAILY_MISSION_ARC] = cui_daily_mission_arc;
  lv_obj_add_event_cb(cui_dailymissiongroup, get_component_child_event_cb,
                      LV_EVENT_GET_COMP_CHILD, children);
  lv_obj_add_event_cb(cui_dailymissiongroup, del_component_child_event_cb,
                      LV_EVENT_DELETE, children);
  lv_obj_add_event_cb(cui_daily_mission_arc,
                      ui_event_comp_dailymissiongroup_daily_mission_arc,
                      LV_EVENT_ALL, children);
