...
namespace MOONCAKE {
    ...
    void Framework::_system_data_init()
    {
        ...
        _config.database->Add<bool>(MC_TIME_JUST_SET, bool(false));
        #endif

        /* Screen */
        _config.database->Add<int32_t>(MC_BRIGHTNESS, int32_t(50));
        _config.database->Add<bool>(MC_BRIGHTNESS_JUST_SET, bool(false));
