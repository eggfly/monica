...
// Address
// (Indirect,X)
#define AA_IX    K6502_ReadZpW( K6502_Read( (PC++,PC-1) ) + X )
// (Indirect),Y
#define AA_IY    K6502_ReadZpW( K6502_Read( (PC++,PC-1) ) ) + Y
// Zero Page
...
// Absolute
#define AA_ABS   ( K6502_Read( (PC++,PC-1) ) | (WORD)K6502_Read( (PC++,PC-1) ) << 8 )
// Absolute2 ( PC-- )
#define AA_ABS2  ( K6502_Read( (PC++,PC-1) ) | (WORD)K6502_Read( PC ) << 8 )
// Absolute,X
